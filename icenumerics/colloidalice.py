...
class colloidal_ice(list):
    ...
    def simulation(self, world, name, targetdir = '', include_timestamp = True, run_time = 60*ureg.s, framerate = 15*ureg.Hz, timestep = 100*ureg.us, output = ["x","y","z"], processors = 1, neighbors = "nsq"):
